...
let%expect_test "a.:[(msb,lsb)]" =
  let x = of_int ~width:32 0x7eadbeef in
  Stdio.printf !"x = %{Bits}\n" x;
  ...
  [%expect
    {|
    x = 01111110101011011011111011101111
      x.:[(31,0)] = 01111110101011011011111011101111
      x.:[(5,0)] = 101111
      x.:[(14,7)] = 01111101
      x.:[(23,19)] = 10101 |}]
;;
...
let%expect_test "a.:-[(msb option, width)]" =
  ...
  [%expect
    ...
    x = 01111110101011011011111011101111
      ...
      x.:+[(None, 20)] = 01111110101011011011 |}]
;;
